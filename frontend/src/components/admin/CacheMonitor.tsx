      ...
      {stats && (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <div className="p-4 bg-white rounded-lg border">
            ...
            <div className="mt-2">
              <p className="text-3xl font-semibold">{formatUptime(stats.uptime)}</p>
            </div>
          </div>

          {/* Operations */}
          <div className="p-4 bg-white rounded-lg border md:col-span-2 lg:col-span-4">
            <h3 className="text-sm font-medium text-gray-500 mb-4">Operations</h3>
            <div className="grid grid-cols-3 gap-4">
              <div>
                <p className="text-2xl font-semibold">{stats.operations.gets}</p>
                <p className="text-sm text-gray-500">Gets</p>
              </div>
              <div>
                <p className="text-2xl font-semibold">{stats.operations.sets}</p>
                <p className="text-sm text-gray-500">Sets</p>
              </div>
              <div>
                <p className="text-2xl font-semibold">{stats.operations.deletes}</p>
