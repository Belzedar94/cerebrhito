...
export const authRequest = (
  ...
  return request(context.app)
    [method].bind(request(context.app))
...
export const userApi = {
  // Get current user
  getCurrentUser: (context: TestContext) => authRequest(context, 'get')('/api/users/me'),
...
export const childApi = {
  // Get user's children
  getChildren: (context: TestContext) => authRequest(context, 'get')('/api/children'),
...
export const activityApi = {
  // Get activities
  getActivities: (context: TestContext) => authRequest(context, 'get')('/api/activities'),
...
export const milestoneApi = {
  // Get milestones
  getMilestones: (context: TestContext) => authRequest(context, 'get')('/api/milestones'),
...
export const milestoneTrackingApi = {
  ...
  updateMilestoneTracking: (context: TestContext, childId: string, trackingId: string, data: any) =>
    authRequest(
      context,
      'put'
    )(`/api/children/${childId}/milestone-tracking/${trackingId}`).send(data),
...
export const mediaApi = {
  ...
  uploadMedia: (context: TestContext, childId: string, file: any) =>
    authRequest(
      context,
      'post'
    )(`/api/children/${childId}/media`).attach('file', file.buffer, file.originalname),
...
export const aiChatApi = {
  // Get chat history
  getChatHistory: (context: TestContext) => authRequest(context, 'get')('/api/ai/chat/history'),
