...
router.put('/areas/:areaId',
  ...
  validateRequest({
    ...
    body: developmentAreaSchema.partial().refine(
...
// Milestone media
router.post('/milestones/:milestoneId/media',
  authMiddleware.requireRole(['professional']),
  validateRequest({
    params: z.object({
      milestoneId: idSchema
...
router.delete('/milestones/:milestoneId/media/:mediaId',
  authMiddleware.requireRole(['professional']),
  validateRequest({
    params: z.object({
      milestoneId: idSchema,
...
router.get('/child/:childId/milestones',
  validateRequest({
    params: z.object({
      childId: idSchema
    }),
...
router.get('/child/:childId/milestones/achieved',
  validateRequest({
    params: z.object({
      childId: idSchema
    }),
...
router.get('/child/:childId/milestones/upcoming',
  validateRequest({
    params: z.object({
      childId: idSchema
    }),
...
router.put('/milestones/track/:trackingId',
  validateRequest({
    params: z.object({
      trackingId: idSchema
    }),
    body: milestoneTrackingSchema.partial().extend({
...
router.get('/child/:childId/report',
  validateRequest({
    params: z.object({
      childId: idSchema
    }),
...
router.get('/child/:childId/insights',
  validateRequest({
    params: z.object({
      childId: idSchema
    }),
...
router.post('/child/:childId/observations',
  authMiddleware.requireRole(['professional']),
  validateRequest({
    params: z.object({
      childId: idSchema
...
router.get('/child/:childId/observations',
  validateRequest({
    params: z.object({
      childId: idSchema
    }),
